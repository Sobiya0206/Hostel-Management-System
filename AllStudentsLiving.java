...
public class AllStudentsLiving extends javax.swing.JFrame {
    ...
    public AllStudentsLiving() {
        ...
        try
        {
            ...
            while(rs.next())
            {
                model.addRow(new Object[]{rs.getString(2),rs.getString(1),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7),rs.getString(8),rs.getString(9),rs.getString(11),rs.getString(12)});
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Mobile Number", "father Name", "Mother Name", "Email", "Address", "College Name", "Aadhar Number", "Room Number", "Food Type", "Duration"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 45, 665, -1));
