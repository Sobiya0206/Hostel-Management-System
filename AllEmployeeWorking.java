...
public class AllEmployeeWorking extends javax.swing.JFrame {
    ...
    public AllEmployeeWorking() {
        ...
        try
        {
             ...
             ResultSet rs=st.executeQuery("select *from emlpoyee where status ='Working'");
            while(rs.next())
            {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(657, 0, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 720, 450));
